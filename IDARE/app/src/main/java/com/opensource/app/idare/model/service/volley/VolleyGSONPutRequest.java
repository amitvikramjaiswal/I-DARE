 ...
 */
public class VolleyGSONPutRequest<T> extends JsonRequest<T> {

    private static final String TAG = VolleyGSONPutRequest.class.getSimpleName();
    ...
    public VolleyGSONPutRequest(String url, Type type, String body, Map<String, String> mHeaders,
                                Listener<T> listener, Response.ErrorListener errorListener) {

        super(Method.PUT, url, body, listener, errorListener);
        this.type = type;
        gson = new Gson();
